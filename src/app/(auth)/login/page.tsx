    ...
    <div className="glass-card p-8 animate-[scale-in_0.3s_ease-out]">
      <div className="text-center mb-6">
        ...
        <p className="text-sm text-[var(--color-muted-foreground)] mt-1">
          Masuk untuk mulai mencatat kuliah
        </p>
      </div>

      {/* Google Login */}
      <button className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-xl border border-[var(--color-border)] bg-white/5 hover:bg-white/10 transition-colors text-sm font-medium">
      ...
      <div className="flex items-center gap-3 my-6">
        ...
        <span className="text-xs text-[var(--color-muted-foreground)]">atau</span>
        <div className="flex-1 h-px bg-[var(--color-border)]" />
      </div>
